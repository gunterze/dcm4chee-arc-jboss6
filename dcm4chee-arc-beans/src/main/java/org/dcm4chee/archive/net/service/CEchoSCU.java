 ...
 */
public class CEchoSCU implements CEchoSCUMBean {
    ...
    public String cecho(String localAET, String remoteAET) {
        ...
        try {
            ...
            try {
                ...
                rsp.next();
                return rsp.getCommand().toString();
            } finally {
                as.release();
            }
        } catch (Exception e) {
